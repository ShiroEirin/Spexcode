...
2. Adopt a repo
     cd <your-repo> && spex init --harness claude,codex,opencode,pi,zcode,snow,claude-headless,opencode-headless,pi-headless,codex-headless   # seeds .spec/ + git hooks (additive, never overwrites)
