...
export default function RichText({ children, className = '', softBreak, renderSpecRef, renderEvidence, renderTimeAnchor, renderFileRef, renderWidgetRef, renderIssueRef }) {
