...
code:
  ...
  - spec-forge/src/drivers/gitlab.ts#parseRemote
  - spec-forge/src/drivers/gitlab.ts#credentialToken
related:
...
adopter-a's `dev.innerdev.cn`) behind the same driver shape, selected by host id — product code never
