...
dock's head stands beneath the control rather than hosting it. Only spec documents render the control and
reserve its column. Other documents, including the session timeline, end at their last visible action with
the normal band padding; no invisible context control occupies a blank button-sized space. The
