...
cd your-repo
spex init --harness claude,codex,opencode,pi,zcode,snow,claude-headless,opencode-headless,pi-headless,codex-headless   # seeds .spec/, installs hooks, materializes the agent contracts
```
